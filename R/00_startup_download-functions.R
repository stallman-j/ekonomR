...
#' a vector where indices match with sub_urls

# 2023-04-12 haven't checked since updating if it works with zip files
...
# # if true you need to provide username = and password =
#' # if prompted, can either "" block out with quotes or just copy+paste directly
