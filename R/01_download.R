...
#' @param pass_protected logical, default is FALSE. Set to TRUE if the data requires a simple username and login. If pass_protected = FALSE and username = NULL and password = NULL, then the system will prompt you for the username and password for EVERY new download. Avoid this by setting username and password.
...
#' @param zip_file logical, whether you're downloading files of the form ".zip". If so, setting zip_file to TRUE will automatically unzip these files and store them in a folder given by data_raw/data_subfolder. Default is FALSE.
