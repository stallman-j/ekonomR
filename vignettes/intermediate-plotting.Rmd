...
You're likely coming here from the vignette "Simple Plotting with a Review of R Coding Basics." If you're not and the following seems sudden, check out that first!
