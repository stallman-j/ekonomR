...
```{r, echo = FALSE}
url <- paste0("https://github.com/stallman-j/ekonomR/blob/main/output/03_maps/",paste0(country_name, "_with_",num_localities,"_at-level_",level,"_randomly-chosen.png"),"?raw=true")
