...
- Are the creators of the data documenting facts (like counting things), making estimates or inferences, or asking opinions?
- Does the data they're presenting seem to square with what I would expect from data like this?
- If data are missing, is it missing randomly, or is there some pattern to the data that are missing that could influence my interpretation of results achieved from this data?
