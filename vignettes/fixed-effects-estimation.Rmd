...
# Refresher of fixed effects and dummy variables
...
I'm now going to assume I can use the jargon from these concepts.
...
rows <- data.frame("term" = c("Mean","Year FE","Country FE"),
                   "(1)"  = c(round(mean(data_cross_section[[reg_1_vars$outvar]]),2), "N","N"),
                   "(2)"  = c(round(mean(data_cross_section[[reg_2_vars$outvar]]),2), "Y","N"),
                   "(3)"  = c(round(mean(data_cross_section[[reg_3_vars$outvar]]),2), "N","Y"),
                   "(4)"  = c(round(mean(data_cross_section[[reg_4_vars$outvar]]),2), "Y","Y"))
