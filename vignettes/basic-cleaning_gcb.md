...
*Comprehension check*: What would happen if we told `pivot_longer()` to use *all* the columns, and didn't omit `year`? (If you're not sure, try it with `cols = names(.)`.
